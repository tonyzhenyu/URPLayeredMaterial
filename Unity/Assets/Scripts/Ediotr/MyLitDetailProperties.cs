...
public class MyLitDetailProperties
{
    public static class Styles
    {
        ...
        public static readonly GUIContent detailPbrMaskText = EditorGUIUtility.TrTextContent("PBR Mask Map","pbr mask ");
    }
    ...
    public struct DetailProperties
    {
        ...
        public MaterialProperty detailPBRMask;
        ...
        public DetailProperties(MaterialProperty[] properties)
        {
            ...
            detailPBRMask =  BaseShaderGUI.FindProperty("_DetailPBRMaskMap", properties, false);
            
        }
    }

    public static void DoDetailArea(DetailProperties properties, MaterialEditor materialEditor)
    {
        ...
        materialEditor.TexturePropertySingleLine(Styles.detailPbrMaskText, properties.detailPBRMask);
